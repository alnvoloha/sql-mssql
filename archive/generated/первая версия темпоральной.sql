...
-- ИМИТАЦИЯ ИЗМЕНЕНИЙ ЗА 01.03.2022

-- ДОБАВЛЕНИЯ (INSERT) — 5 строк в разных таблицах
INSERT INTO dbo.Employee (Lastname, Middlename, Name) 
VALUES ('Karpov', 'Petrovich', 'Lev');

INSERT INTO dbo.Department (PK_DepartmentName, EmployeeQuantity)
VALUES ('CustomerCare', 7);

INSERT INTO dbo.ExpenseType (PK_ExpenseTypeName, Description)
VALUES ('PR', 'Связи с общественностью');

INSERT INTO dbo.ExpenseLimit (PK_DepartmentName, PK_ExpenseTypeName, DataLimit, MaxPayment)
VALUES ('CustomerCare', 'PR', '2022-01-01', 4200.00);

INSERT INTO dbo.Purchase (PK_IDEmployee, PK_DepartmentName, PK_ExpenseTypeName, DataLimit, PurchaseData, PurchaseSum)
VALUES (2, 'CustomerCare', 'PR', '2022-01-01', '2022-03-10', 1200.00);

-- ОБНОВЛЕНИЯ (UPDATE) — 5 строк в разных таблицах
UPDATE dbo.Employee
SET Lastname = 'Volodin'
WHERE PK_IDEmployee = 5;

UPDATE dbo.Department
SET EmployeeQuantity = 10
WHERE PK_DepartmentName = 'Operations';

UPDATE dbo.ExpenseType
SET Description = 'Обслуживание IT-инфраструктуры'
WHERE PK_ExpenseTypeName = 'Maintenance';

UPDATE dbo.ExpenseLimit
SET MaxPayment = 9500.00
WHERE PK_DepartmentName = 'Sales' AND PK_ExpenseTypeName = 'Hardware' AND DataLimit = '2022-01-01';

UPDATE dbo.Purchase
SET PurchaseSum = 1800.00
WHERE PK_IDEmployee = 4 AND PK_IDPurchase = 4;

-- УДАЛЕНИЯ (DELETE) — 3 строки в разных таблицах
DELETE FROM dbo.EmployeePosition
WHERE PK_DepartmentName = 'Legal' AND PK_IDEmployee = 5;

DELETE FROM dbo.ExpenseType
WHERE PK_ExpenseTypeName = 'HRServices';

DELETE FROM dbo.DepartmentExpenses
WHERE PK_DepartmentName = 'Finance' AND PK_ExpenseTypeName = 'Subscriptions' AND DataLimit = '2022-01-01';
